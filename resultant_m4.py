...
def MOD_PP_P(arr, arr1):
    ...
    temp1 = copy.deepcopy(arr1)
    chas = DIV_PP_P(temp, temp1)  # Находим частное от деления двух многочленов
    k = MUL_PP_P(chas, arr1)  # Произведение частного на второй многочлен
