...
#если старшая степень 1-го многочлена больше второго, то находим разницу стпеней и p присваиваем стпень 1-го многочлена
#проходим по циклу, если p превосходит n, то присваиваем значения числителя и знаменателя в результитрующий массив и уменьшаем p
#если же p не превосходит n, то проверяем условие, если m превосходит n, то складываем коэффициенты многочленов
#если же старшая степень 1-го многочлена меньше 2-го, то делаем все то же самое, но только меняем местами многочлены
